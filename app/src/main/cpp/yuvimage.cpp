...
#include "yuv/YuvToJpegEncoderMT.h"
#include "almashot/almashot.h"
#include "almashot/almashot_raw.h"
...
Java_com_jike_ultracamera_image_YuvImage_SaveJpegFreeOut(JNIEnv* env, jclass clazz, int jout,
		int format, int width, int height, jintArray offsets,jintArray strides,
		int jpegQuality, jobject jstream, jbyteArray jstorage)
{
	jbyte* OutPic;

	OutPic = reinterpret_cast<jbyte *>(jout);
...
Java_com_jike_ultracamera_image_YuvImage_RemoveFrame(JNIEnv* env,jclass clazz){
	free((void*)yuv);
}

extern "C"
JNIEXPORT jint JNICALL
Java_com_jike_ultracamera_image_YuvImage_GetFrame(JNIEnv* env, jclass clazz){
	return yuv[0];
}

extern "C"
JNIEXPORT jbyteArray JNICALL
Java_com_jike_ultracamera_image_YuvImage_GetByteFrame(JNIEnv* env, jclass clazz){
	int x, y;
...
//extern "C" JNIEXPORT int JNICALL Java_com_jike_ultracamera_image_YuvImage_CreateYUVImageFromRAW
//(
//		JNIEnv* env,
//		jclass clazz,
//		jobject buf,
...
Java_com_jike_ultracamera_image_YuvImage_CreateYUVImage
(
		JNIEnv* env,
		jclass clazz,
		jobject bufY,
...
extern "C" JNIEXPORT jbyteArray JNICALL Java_com_jike_ultracamera_image_YuvImage_CreateYUVImageByteArray
(
		JNIEnv* env,
		jclass clazz,
		jobject bufY,
...
extern "C" JNIEXPORT int JNICALL Java_com_jike_ultracamera_image_YuvImage_AllocateMemoryForYUV
(
		JNIEnv* env,
		jclass clazz,
		jint sx,
