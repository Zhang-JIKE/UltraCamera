...
public class NightSightModule extends BaseModule{
    ...
    public int getIconResId() {
        return R.drawable.ic_indicator_night;
    }
    ...
    public void onPictureTaken(CameraDevice cameraDevice,
        ...
        for (int i = 0; i < saver.getProcessor().getFrameCount(); i++) {
            ...
            builderSuperNight.set(CaptureRequest.SENSOR_SENSITIVITY,
                    (int) ((CameraPara.iso / (CameraPara.ONE_SECOND_DIV_4 / CameraPara.exposureTime)) * CameraPara.isoBoost / 100f) * 4);
